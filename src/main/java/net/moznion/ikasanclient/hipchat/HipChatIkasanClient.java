...
public class HipChatIkasanClient implements IkasanClient {
    ...
    public static class HipChatIkasanClientBuilder {
        private final String host;
        ...
        public HipChatIkasanClientBuilder(String host) {
            this.host = host;
        }

        public HipChatIkasanClient build() throws KeyStoreException, NoSuchAlgorithmException, KeyManagementException {
            return new HipChatIkasanClient(this);
        }
    }

    public static HipChatIkasanClientBuilder builder(String host) {
        return new HipChatIkasanClientBuilder(host);
    }

    private HipChatIkasanClient(HipChatIkasanClientBuilder b) throws KeyStoreException, NoSuchAlgorithmException, KeyManagementException {
        this.host = b.host;
        this.port = b.port;
